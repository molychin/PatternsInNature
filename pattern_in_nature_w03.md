...
具有对称形状的自然图案，如蜜蜂的蜂巢，让我们惊喜和高兴，正是因为它们相当罕见。
...
树的分形分支是有限度的，因为真实的物体是由有形的物质构成的，在其细节中不可能变得无限精细。如果没有别的东西，扭动和皱褶不能比制造物体的原子更小。还有一个上限：你不会得到像山那么大的树。因此，具有类似自相似分形结构的所有自然物体仅在特定范围的尺度上这样做。

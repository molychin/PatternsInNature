...
--
螺旋软管螺旋被称为阿基米德螺旋，因为阿基米德在公元前三世纪的螺旋书中描述了它。当它出现在物理世界中时，这通常是因为它确实来自于以恒定宽度卷起一些长的或扁平的物体：绳子、一张纸或地毯、蠕虫。与此同时，蜗牛壳有一种叫做对数螺旋的形式，因为写描述它的数学方程的一种方法涉及对数。这个螺旋有一个非常特殊的特性：不管它有多小或多大，它的形状都保持不变。这是另一个自相似模式的例子。

自我相似在这里意味着什么？螺旋形不是一直都是螺旋形吗？是的，但有区别。首先，阿基米德螺旋线只能小到不能小。当线圈的半径和宽度相同时，你就到了极限：你不能把绳子绕得比这个更紧。但是随着对数螺旋旋转到它的中心，线圈会越来越窄，所以曲率会越来越紧。你可以说宽度的减小与曲率的增大保持着完美的速度，所以螺旋运动不受限制。
...
--
另一种说法是，无论你在什么样的尺度上看到螺旋，它看起来都是一样的。放大蜗牛壳的中心，曲线看起来和以前一样。原则上，对数螺旋可以永远向内或向外弯曲，其形式永远不会改变。

这种自我相似性正是像蜗牛一样的腹足类软体动物所需要的。随着生物体的生长，它需要一个更大的外壳。但是贝壳是由坚硬的碳酸钙构成的，碳酸钙与粉笔和大理石是同一种矿物。它不能膨胀，而且要让蜗牛永远把壳拆开去造一个新的壳是非常困难的。所以软体动物只是增加了一个延伸，从上一个边缘生长出一个更大的房子。

外壳的早期部分，现在太窄了，只是被丢弃了。
...
--
边缘的逐渐扩大可以产生一个圆锥体，这当然是生物的一个选择。但是为了避免承受不断增长的负担，圆锥体被紧紧地卷成螺旋形，这或多或少就像对数螺旋壳：一种卷起的圆锥体。

所以对数螺旋是一种很好的腹足动物设计。然而，它并不“知道”这一点。它需要注意的是一条生长规律，即“保持边缘形状不变，但以稳定的速度增加周长”。要使圆锥体整齐地卷曲成对数螺旋，只需添加一个条件，即边缘一侧的生长速度比另一侧快：圆锥体随后会自动旋转。这个简单的原理就足以通过改变贝壳口的周长来构造各种不同的贝壳形状，就像在不同种类的海洋腹足动物身上看到的那样。
...
--
还没有人知道为什么向日葵种子采用这种算术安排。一个长期存在的观点是，当小花或种子或叶子从生长的茎尖发芽时，它能使它们最有效地包装起来。换句话说，只有当一个新的芽能够找到足够的空间来这样做时，它才会出现。这只是一个几何问题：如果要将对象排列在从中心源螺旋出的数组中，那么一个对象与下一个对象之间的角度应该是什么？事实证明，最有效的包装，使双螺旋菲波纳契模式千叶，是其中一个角约137.5˚被称为黄金角。

然而，这并不是全部的解释。首先，植物如何“测量”下一个芽应该去哪里？斐波那契序列和包装概念描述了向日葵的头状花序是如何排列的，但没有解释它们是如何实现这种排列的。一种可能的解释是，涉及到触发芽形成的生长激素的生物化学过程实际上在一个芽和另一个芽之间产生了一种排斥力，因此它们与螺旋中心的夹角不能小于黄金夹角。
...
--
另一种理论是使芽保持一定距离的“力”，将芽排列成螺旋状排列，不是化学的（由激素引起），而是机械的：

它来自茎尖软组织的起皱和屈曲。在茎的最顶端，“皮肤”是柔软和有弹性的，但在茎的最下面变得更硬更硬。茎的生长方式会压缩靠近尖端的较硬的织物并使其扣紧。也许新的芽会从这些皱纹的顶端发芽。对这种弯曲的计算表明，这种形状可能类似于斐波那契螺旋形，即围绕茎干中心的小螺旋形峰，或者植物两侧的同心对称褶皱，依次为北-南、东-西等等。这也是在叶序中发现的一种模式。
...
--
他弯曲模型看起来特别吸引人解释一些仙人掌的芽安排，在那里，粗短的，螺旋状的突起看起来更像硬皮肤上的皱纹。这种协调的折叠使软组织在有水吸收时很容易迅速膨胀。规则的褶皱和凹槽在南瓜和葫芦等果肉坚硬的外皮上很常见。这些也可能是由水果生长和膨胀时在皮肤中产生的压力自我组织的模式。

指尖的皱纹可以发展成螺旋状的同心螺纹。因为指纹上的皱纹或多或少都有相同的宽度，所以螺纹不是对数螺旋，而是更像是绳的阿基米德螺旋。这里的屈曲似乎是由不同的皮肤层在胎儿早期发育时以不同的速度生长造成的。指纹螺纹往往是在你的指尖垫的中心，那里的表面曲率最大。

...
根据现代理论，气体和尘埃的流动分解成湍流漩涡。这些漩涡相互冲突并互相残杀，除了那些没有碰撞的漩涡。不出意外地发生的是，剩下的漩涡，避免碰撞的漩涡，彼此之间以规则的间隔隔开。那些漩涡进一步浓缩并产生了行星，因此行星也最终会有规律的间距。因此，该理论的细节解释了为什么太阳系中的每个连续行星距离太阳的距离是前一行星的两倍。
在关于行星创造的故事中，我们看到了一种进化论在起作用。我们看到了不合适的漩涡，相互碰撞的漩涡，以及适合的生存，最初定位的漩涡以避免碰撞。最终的结果是有序的安排，看起来更像是设计的产物而非机会。秩序源于混乱。然而，有趣的是，混乱仍然存在。事实上，考虑到涡旋碰撞产生的散热，以及尘埃和气体在形成行星时的凝结，系统的无序或熵实际上已经增加。当地事件的顺序 - 行星的间距 - 不仅仅是由宇宙其他部分的无序 - 热量增益来补偿。
...
当我们考虑具有低雷诺数的流量时，我们甚至可以更直接地看到大尺寸秩序的产生。 在低雷诺数下，涡旋相互交替并形成规则行。 这种流动并非真正动荡，也不稳定; 相反，它们“几乎稳定”或周期性的。
...
在一条溪流中的岩石或一只划独木舟的桨后，你经常会看到两个相反的漩涡。在一个更大的障碍物后面，比如一条快速流动的河流中的桥台，您会看到这两个漩涡有节奏地剥落并向下游流动，并从一个边缘流向另一个边缘，然后从另一个边缘流出。图40显示了在空气流中的一个交替的涡流流，该空气流中充满了来自气溶胶喷雾的油滴。空气绕着固定的电缆流动，产生周期性的模式，称为涡街。从电缆一侧的涡流生长，直到它穿过它的材料。
...
有人建议，游泳鱼，产生自己的漩涡，可能会利用这些漩涡的旋转和骑在蜿蜒的道路之间，就像在滚轮之间骑行的移动带（图41A）。 然而，最近海因里希·赫特尔（Heinrich Hertel）确定，至少对于一条游泳蛇来说，两排涡旋被压成一条线，并且动物的身体穿过每个漩涡的中心而不是环绕它（图41）b）。有趣的是，蛇后面没有新的漩涡，也就是说，没有反冲。
此外，涡流保持在它们形成的位置上，它们不向下游流动。没有尾流和涡流运动证明了蛇的游泳运动的效率。

![](res/p1/2019-5-29-18-12-40.png)
...
也有人推测，鸟类为了适应对方的涡流和尾迹而在一个V形状中旅行。每只鸟向下推它下面的空气的反应在它周围产生一个上升气流。如果其他鸟类靠近，他们可以使用那些上升气流保持自己的高度。如果整个群都飞在一个V形物中，所有的鸟都有大约相同数量的上升气流，因为每个鸟都向前飞到前面的鸟的上升气流中。领头鸟也很有助力，因为它的两侧都是鸟的后援。因此，每只单独的鸟都会乘坐它的邻居的踪迹，计算表明，一组二十五只鸟能比单独一只鸟飞得多70%而更远。
...
人类，以及鸟类和蛇，利用周期性的流动模式——但以一种意想不到的方式。我们倾听他们的声音。如果涡街中的漩涡从障碍物中剥离，频率在50赫兹到20000赫兹（每秒周期）之间，我们会听到悠扬的嗡嗡声和口哨声。风琴、树枝、电话线、笛子、风琴管和茶壶都通过在可听见的频率范围内生成漩涡而产生声音。
...
我们偶尔会受到更大规模的涡街影响。我们现在知道，规则涡旋导致了1940年塔科马海峡吊桥的坍塌。随着四十二英里每小时的稳定风吹过三十九英尺宽的巷道，涡旋从一个边缘剥离，然后从另一个边缘剥离，会导致桥梁自身扭曲。首先是单向的，然后是另一个。坍塌后，该桥改建成一个箱形截面而不是H形截面，以便更好地抵抗扭转或扭曲，并且箱体的所有表面均由开放的桁架构成，以减少暴露在风中的材料量，减少雷诺兹方程中的面积。
